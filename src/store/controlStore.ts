...
export const CONTROL_ROWS: readonly ControlRow[] = [
  ...
  { id: 'lp', label: 'J — быстрая атака рукой', detail: 'Обычный удар' },
  { id: 'lk', label: 'K — сильная атака верхом', detail: 'Обычный удар' },
  { id: 'hp', label: 'I — быстрая атака ногой', detail: 'Обычный удар' },
  { id: 'hk', label: 'L — сильная атака ногой', detail: 'Обычный удар' },

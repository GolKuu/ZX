...
function snapshotFighter(fighter: MutableFighterState): FighterSnapshot {
  return {
    ...
    guardMode: fighter.guardMode,
    guardHealth: fighter.guardHealth,
    resource: fighter.resource,
    resourceMaximum: fighter.resourceMaximum,
    resourceLockFrames: fighter.resourceLockFrames,
    resourceOverdrive: fighter.resourceOverdrive,
    statusId: fighter.statusId,
    statusFrames: fighter.statusFrames,

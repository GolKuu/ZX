...
export const AI_DIFFICULTIES = [
  {
    id: 'EASY',
    label: 'Лёгкий',
    description: 'Спокойно держит дистанцию, блокирует явные атаки и не спамит.',
  },
  {
    id: 'MEDIUM',
    label: 'Средний',
    description: 'Чередует сближение, защиту и контрудары после перегрузки соперника.',
  },
  {
    id: 'HARD',
    label: 'Сложный',
    description: 'Читает темп боя, бережёт свой ритм и наказывает повторяющиеся атаки.',
  },
  {
    id: 'VERY_HARD',
    label: 'Очень сложный',
    description: 'Быстрая реакция, точные наказания, +25% здоровья и 35 стартовой энергии.',
  },
] as const;

...
export const LUCKY_MOVES: readonly MoveFrameData[] = [
  ...
  luckyMove({ id: I.loadedShoulder, startup: 10, active: 4, recovery: 14, damage: 56, level: 'mid', reach: 0.88, height: 1.18, lunge: 0.32, cancels: [I.fortuneHeel] }),
  ...
  luckyMove({ id: I.throw, startup: 7, active: 2, recovery: 22, damage: 75, level: 'mid', reach: 0.5, height: 1.05, grapple: ['normal', 24, 'grounded'] }),
  luckyMove({ id: I.airThrow, startup: 8, active: 3, recovery: 23, damage: 72, level: 'air', reach: 0.48, height: 1.45, grapple: ['air', 24, 'airborne'] }),
];

...
const rows: readonly VorghRow[] = [
  ...
  },
  {
    ...
    hits: [
      { ...hit([0.68, 1.52, 0.45, 0.3], 30, 16, [0.08, 0]), from: 8, to: 11 },
      { ...hit([0.83, 1.12, 0.5, 0.36], 38, 22, [0.16, 0.1]), id: 'second', from: 13, to: 16 },
    ],
  ...
  },
  {
    ...
    hits: [hit([0.94, 0.5, 0.62, 0.24], 65, 27, [0.24, 0.08])],
  ...
  },
  {
    ...
    hits: [{
      ...hit([0.7, 1.28, 0.52, 0.55], 82, 34, [0.28, 0.2]),
      wallBounce: {
...
function hit(
  ...
  return { box, damage, hitstun, push, hitstop: [9, 12] as const };
}

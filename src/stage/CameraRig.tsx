...
export function CameraRig() {
  ...
  useFrame(({ clock }, delta) => {
    ...
    camera.position.x = Math.sin(time * 0.24) * 0.09 + Math.sin(time * 67) * 0.055 * shake;
    camera.position.y = 3.25 + Math.sin(time * 51) * 0.035 * shake;
    camera.position.z = 8.2 + Math.sin(time * 59) * 0.06 * shake;

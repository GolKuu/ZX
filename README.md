...
Первый рабочий каркас яркого браузерного файтинга для двух игроков за одной клавиатурой.
React отвечает за сайт и маршруты, Phaser — за арену, а независимая `CombatSimulation` работает
с фиксированным шагом 60 Гц.

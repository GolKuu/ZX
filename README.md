...
Комета и Импульс визуально различаются, каждый приём имеет собственную процедурную
графику, а воздушное управление позволяет перепрыгнуть соперника и сменить сторону.
